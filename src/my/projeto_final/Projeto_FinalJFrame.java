...
public class Projeto_FinalJFrame extends javax.swing.JFrame {

    public Projeto_FinalJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rede de conhecimento");
        ...
        jButton2.setText("Procurar especialidade");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Cadastrar CadWindow = new Cadastrar();
        CadWindow.setVisible(true);
        CadWindow.setTitle("Cadastro");
        CadWindow.setLocation(500, 250);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Procurar ProcWindow = new Procurar();
        ProcWindow.setVisible(true);
        ProcWindow.setLocation(500, 250);
        ProcWindow.setTitle("Procurar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Projeto_FinalJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Projeto_FinalJFrame().setVisible(true);
            }
        });
    }
