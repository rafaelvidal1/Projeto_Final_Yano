...
public class Cadastrar extends javax.swing.JFrame {
    ...
    private void CadastrarBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CadastrarBtActionPerformed
        try{
            ...
            Connection link = DriverManager.getConnection(url,username,senha);
            Statement st = link.createStatement();
            String Query = "INSERT INTO PROF(NOME , AREACON , NIVEL , CONESP) VALUES ('"+nomeText.getText()+"','"+AreaConBox.getSelectedItem()+"','"+nivelBox.getSelectedItem()+"','"+ConEspText.getText()+"')";
